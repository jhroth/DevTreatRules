...
```
Based on the above estimates in the validation set, we decide to select two rules to bring forward to the evaluation set: (1) split-regression with logistic/logistic as the propensity/rule methods 
...
and (2) direct-interactions with logistic/lasso as the propensity/rule methods
...
```{r DIL_on_eval, warning=FALSE}
set.seed(123)
DI.eval <- EvaluateRule(data=evaluation.data,
