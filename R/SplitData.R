...
#' @return A data.frame equal that appends a column named `partition' to \code{data}, which is a factor variable with levels equal to `development' and `evaluation' (if \code{n.sets=2}  or to  `development', `validation', and `evaluation' (if \code{n.sets=3}) 
#' @examples
#' set.seed(123)
